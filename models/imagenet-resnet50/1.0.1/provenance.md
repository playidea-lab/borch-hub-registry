# imagenet-resnet50 1.0.0

**우리가 학습한 가중치가 아니다.** 남이 학습한 것을 옮겨 왔고, 이 파일이
그 출처다.

- 출처: `timm 1.0.28` 의 `resnet50`
- 체크포인트: `timm/resnet50.a1_in1k`
- 가중치 라이선스: apache-2.0
- 열쇠 320개 · 102,470,196 바이트
- sha256 `2572b495bf4b23c24f1a7161254b6b87c36544c0ed9f97f997c4e14d7b32a036`

## 수 — 무엇을 누가 쟀는지

매니페스트의 `metrics` 에 **우리가 잰 수**가 들어 있다. ImageNet-V2 에서
top-1 0.68, 표본 1000 장(클래스마다 한 장).

같은 사진에 timm 을 돌린 것이 0.684 다. 이 수가 옆에 있어야 위 수가
